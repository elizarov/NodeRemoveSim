...
An example execution that produces this state:
  ...
  N0(next=1,prev=_,A), N1(next=2,prev=0,R), N2(next=3,prev=1,A), N3(next=_,prev=2,A) -> P1 @3: node.next.prev = prev
  ...
  N0(next=1,prev=_,A), N1(next=2,prev=0,R), N2(next=3,prev=0,R), N3(next=_,prev=2,A) -> P2 @3: node.next.prev = prev
  N0(next=1,prev=_,A), N1(next=2,prev=0,R), N2(next=3,prev=0,R), N3(next=_,prev=0,A) -> P2 @4: node.prev.next = next
  N0(next=3,prev=_,A), N1(next=2,prev=0,R), N2(next=3,prev=0,R), N3(next=_,prev=0,A) -> P1 @4: node.prev.next = next
...
An example execution that produces this state:
  ...
  N0(next=1,prev=_,A), N1(next=2,prev=0,R), N2(next=3,prev=1,R), N3(next=_,prev=2,A) -> P1 @3: node.next.prev = prev
  N0(next=1,prev=_,A), N1(next=2,prev=0,R), N2(next=3,prev=1,R), N3(next=_,prev=0,A) -> P1 @4: node.prev.next = next
  ...
  N0(next=3,prev=_,A), N1(next=2,prev=0,R), N2(next=3,prev=1,R), N3(next=_,prev=0,A) -> P2 @3: node.next.prev = prev
  N0(next=3,prev=_,A), N1(next=2,prev=0,R), N2(next=3,prev=1,R), N3(next=_,prev=1,A) -> P2 @4: node.prev.next = next
